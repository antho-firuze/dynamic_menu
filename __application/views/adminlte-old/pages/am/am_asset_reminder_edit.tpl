...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"Asset Type", label_link:"{$.const.PAGE_LNK}?pageid=132", idname:"asset_type_id", url:"{$.php.base_url('am/am_asset_type')}", remote: true, required: true, disabled: ($act == "edt" ? true : false) }));
	...
	col.push(BSHelper.Input({ horz:false, type:"date", label:"Remind Date", idname:"remind_date", cls:"auto_ymd", format:"{$.session.date_format}", required: true }));
