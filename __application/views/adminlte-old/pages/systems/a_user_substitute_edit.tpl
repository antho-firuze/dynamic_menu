...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"User Substitute", label_link:"{$.const.PAGE_LNK}?pageid=20", idname:"substitute_id", url:"{$.php.base_url('systems/a_user')}", remote: true }));
