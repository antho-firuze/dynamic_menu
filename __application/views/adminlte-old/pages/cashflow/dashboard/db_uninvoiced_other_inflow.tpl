...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"100px", orderable:true, data:"doc_no", title:"Inflow No" },
			{ width:"50px", orderable:true, className:"dt-head-center dt-body-center", data:"doc_date", title:"Inflow Date" },
			...
			{ width:"200px", orderable:true, data:"dDescription", title:"Description" },
		],
		footers: [
