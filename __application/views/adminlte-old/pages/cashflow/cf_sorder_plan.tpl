...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"100px", orderable:false, data:"received_plan_date", title:"Received Plan Date" },
	...
	col.push(BSHelper.Input({ horz:true, lblsize:"col-sm-4", colsize:"col-sm-8", type:"text", label:"Total Plan", idname:"plan_total", style: "text-align: right;", format: format_money_2, required: false, value: 0, readonly: true, }));
