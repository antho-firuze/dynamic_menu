...
<script>
	...
	col.push(BSHelper.Combobox({ horz:false, label:"Department", label_link:"{$.const.PAGE_LNK}?pageid=18,129,130&filter=parent_id={$.session.orgtrx_id}", idname:"department_id", textField:"code_name", url:"{$.php.base_url('systems/a_orgdept_list')}?filter=parent_id={$.session.orgtrx_id}", remote: true }));
