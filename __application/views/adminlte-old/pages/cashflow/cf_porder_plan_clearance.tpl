...
<script>
	...
	col.push(BSHelper.Input({ horz:true, lblsize:"col-sm-4", colsize:"col-sm-8", type:"text", label:"Total Clearance", idname:"plan_cl_total", style: "text-align: right;", format: format_money_2, required: false, value: 0, readonly: true, }));
