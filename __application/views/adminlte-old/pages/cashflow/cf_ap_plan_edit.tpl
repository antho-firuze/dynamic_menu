...
<script>
	...
	col.push(BSHelper.Input({ horz:false, type:"number", label:"Business Partner TOP (Days)", idname:"po_top", style: "text-align: right;", step: ".01", required: false, value: 0, placeholder: "0", readonly: true }));
