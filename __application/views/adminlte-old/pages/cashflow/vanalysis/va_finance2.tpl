...
<script>
	...
	{* Line Chart *}
	col = [], row = [], boxes = [];
	var boxInfo0 = BSHelper.Box({ type:"info", header: true, title: "Cash Received Plan (Customer) vs Actual", icon: "" });
	...
	{* Line Chart 2*}
	col = [], row = [];
	var boxInfo02 = BSHelper.Box({ type:"info", header: true, title: "Cash Received Plan (Other) vs Actual", icon: "" });
	...
	{* Line Chart 3*}
	col = [], row = [];
	var boxInfo03 = BSHelper.Box({ type:"info", header: true, title: "Cash Payment Plan (Vendor) vs Actual", icon: "" });
	...
	{* Line Chart 4*}
	col = [], row = [];
	var boxInfo04 = BSHelper.Box({ type:"info", header: true, title: "Cash Payment Plan (Other) vs Actual", icon: "" });
	...
	function info_box_by_document(){
		...
		datas1.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=1,lvl=1,by=1', value: result.data.total_by_document['total_projection1'] });
		datas2.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=2,lvl=1,by=1', value: result.data.total_by_document['total_projection2'] });
		datas3.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=3,lvl=1,by=1', value: result.data.total_by_document['total_projection3'] });
		datas4.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=4,lvl=1,by=1', value: result.data.total_by_document['total_projection4'] });
		for (var i = 1; i < title.length; i++){
			for (var j = 1; j < field.length; j++){
				...
				window['datas'+i].push({ title: title[j], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc='+i+',lvl='+(j+1)+',by=1', value: fmt });
			}
		}
	...
	function info_box_by_amount(){
		...
		datas1.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=1,lvl=1,by=2', value: format_money(result.data.total_by_amount['total_projection1']) });
		datas2.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=2,lvl=1,by=2', value: format_money(result.data.total_by_amount['total_projection2']) });
		datas3.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=3,lvl=1,by=2', value: format_money(result.data.total_by_amount['total_projection3']) });
		datas4.push({ title: title[0], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc=4,lvl=1,by=2', value: format_money(result.data.total_by_amount['total_projection4']) });
		for (var i = 1; i < title.length; i++){
			for (var j = 1; j < field.length; j++){
				...
				window['datas'+i].push({ title: title[j], link: $BASE_URL+'systems/x_page?pageid=239&filter=fdate='+$("#fdate").val()+',tdate='+$("#tdate").val()+',doc='+i+',lvl='+(j+1)+',by=2', value: fmt });
			}
		}
