...
<script>
	...
	var DataTable_Init = {
		...
		columns: [
			...
			{ width:"70px", orderable:true, className:"dt-head-center dt-body-center", data:"received_plan_date_order", title:"Received Plan Date (SO)" },
			{ width:"70px", orderable:true, className:"dt-head-center dt-body-center", data:"received_plan_date", title:"Received Plan Date (Invoice)" },
			{ width:"100px", orderable:true, data:"doc_no_order", title:"SO Doc No" },
			{ width:"70px", orderable:true, className:"dt-head-center dt-body-center", data:"doc_date_order", title:"SO Doc Date" },
			{ width:"70px", orderable:true, className:"dt-head-center dt-body-center", data:"etd_order", title:"SO ETD" },
			{ width:"100px", orderable:true, data:"doc_ref_no_order", title:"PO Customer" },
